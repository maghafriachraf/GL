...
public class Menu {
    ...
    public static ClientBD clientBD = new ClientBD();
    public static  ReservationBD reservationDAO = new ReservationBD();
    public static  ChargeStationBD chargeStationDAO = new ChargeStationBD();
